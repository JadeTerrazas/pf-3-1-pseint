Algoritmo Calculadora
	...
	Segun option Hacer
		1:
			...
			resultado <- n1 + n2;
			Escribir "El resultado de la suma de ", n1, "+",n2, " es: ", resultado;
		2:
			Escribir "Seleccionaste la resta.";
			resultado <- n1 - n2;
			Escribir "El resultado de la resta de ", n1, "-",n2, " es: ", resultado;
		3: 
			Escribir "Seleccionaste la división.";
			resultado <- n1 / n2;
			Escribir "El resultado de la división de ", n1, "/",n2, " es: ", resultado;
		4:
			Escribir "Seleccionaste la multiplicación.";
			resultado <- n1 * n2;
			Escribir "El resultado de la multiplicación de ", n1, "*",n2, " es: ", resultado;
	FinSegun
Sino 
